...
export default function SubjectUpdate() {
    ...
    return (
        <div className='w-[70%] h-[50%] px-10 py-20 flex flex-col justify-center items-center rounded-3xl bg-black/30 backdrop-blur-sm lg:w-[50%]'>
            <p className='flex flex-col items-center text-2xl font-bold mb-10 text-white'>แก้ไขรายวิชา</p>
            <div className='w-full flex flex-col items-center'>
                <div className='h-auto w-full flex flex-col gap-5 justify-center items-start text-start lg:flex-row lg:gap-10'>

                    <p className='text-lg font-semibold text-white'>รหัสวิชา :</p>
                    <div>
                        <input id='id' onChange={handleChange} className='px-4 w-full h-9 bg-gray-200 rounded-full' />
                        {
                ...
                <div className='flex justify-center mt-7'>
                    ...
                    <button id="edit" onClick={clickAdd} className='w-auto px-4 py-2 mx-3 font-bold text-white rounded-full bg-yellow-500 hover:bg-yellow-600'>
                        ลงทะเบียน</button>
                    <button onClick={clickDelete} className='w-auto px-6 py-2 mx-3 font-bold text-white rounded-full bg-red-500 hover:bg-red-600'>
                        ถอน</button>
                </div>
                ...
                <div className='w-full h-full py-10 px-10 lg:px-30'>
                    <div className='flex mb-7'>
                        ...
                        <p className='self-center text-lg text-rose-700'>{subject.subject_name}</p>
